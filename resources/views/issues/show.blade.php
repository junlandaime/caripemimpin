        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                    <p class="font-medium mb-2">Isu dan Komentar yang dikirimkan harus memenuhi kriteria berikut:</p>
                    ...
                    <ul class="list-disc list-inside space-y-1 text-red-600">
                        <li>Isu dan komentar yang melanggar ketentuan di atas akan dihapus oleh admin tanpa
                            pemberitahuan</li>
