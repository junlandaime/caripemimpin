                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('admin.pairs.index') }}"
                                    class="flex items-center {{ request()->routeIs('admin.pairs.*') ? 'bg-yellow-200 text-yellow-900' : 'bg-white hover:bg-yellow-50 text-gray-900' }} rounded-xl font-bold text-sm py-3 px-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        fill="currentColor" class="text-lg mr-4" viewBox="0 0 16 16">
                                        <path
                                            d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1zm-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zM5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1zm0 2h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1z" />
