            ...
            <table class="min-w-full table-auto">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6 text-left">Tipe</th>
                        <th class="py-3 px-6 text-left">Views</th>
                        <th class="py-3 px-6 text-center">Bendera</th>
                        <th class="py-3 px-6 text-center">Lambang</th>
                        <th class="py-3 px-6 text-center">Aksi</th>
                    </tr>
                </thead>
                <tbody class="text-gray-600 text-sm font-light">
                    @forelse($regions as $region)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">{{ $region->type }}</td>
                            <td class="py-3 px-6 text-left">{{ $region->views }}</td>
                            <td class="py-3 px-6 text-center">
                                @if ($region->bendera)
                                    <img src="{{ asset('storage/' . $region->bendera) }}" alt="Bendera {{ $region->name }}"
                            ...
                            <td class="py-3 px-6 text-center">
                                @if ($region->lambang)
                                    <img src="{{ asset('storage/' . $region->lambang) }}" alt="Lambang {{ $region->name }}"
                                        class="h-10 w-auto mx-auto">
                                @else
                                    -
                                @endif
                    ...
                    @empty
                        <tr class="border-b border-gray-200">
                            <td colspan="5" class="py-3 px-6 text-center">Tidak ada data wilayah</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
